          ...
          <div className="mb-8 pb-6 border-b border-gray-100 flex justify-between items-start">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  View user information and update email
                </p>
              </div>
            </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger asChild>
                <Button className="bg-[#0284B2] hover:bg-[#026a8f] text-white shadow-md shadow-blue-200">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Change the email address for this user. This will update
                    their login and notification preferences.
                  </DialogDescription>
                </DialogHeader>
