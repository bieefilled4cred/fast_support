        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {securityOptions.map((option) => {
            ...
            return (
              <Card
                key={option.id}
                className="shadow-sm border border-[#04B2F1] rounded-xl hover:shadow-md transition-shadow duration-200"
              >
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <div className="flex-1 flex flex-col">
                      <h3 className="text-[14px] font-semibold text-[#464646] ">
                        {option.title}
                      </h3>
                    </div>
                  </div>
                  <p className="text-[12px] text-[#464646]  leading-relaxed">
                    {option.description}
                  </p>
                </CardContent>
              </Card>
